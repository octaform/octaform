...
export default {
  CORE: {
    ...
    field: `Field #{selector} was not found, please check out ${Package.repository.url}#field-name-required`,
    add: `Add method accept only a list of object, please check out ${Package.repository.url}#validator-method-octaformvalidatoradd`,
